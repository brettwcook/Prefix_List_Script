...
def main():
    ...
    target = open('Global_PL_Script.txt', 'w')
    ...
    for key, blank in d.items():
        ...
        if key in plDescDict:
            target.write("no ip prefix-list " + str(key) + "\n")
    ...
    target.write("wr mem" + "\n")
    target.write("!\n")
    target.write("! Soft clear all BGP neighbors to force update " + "\n")
    target.write("!\n")
    target.write("clear ip bgp * soft in" + "\n")
    target.write("!\n")
    target.write("clear bgp vrf * ipv4 unicast * soft out" + "\n")
    target.write("!\n")
    target.write("clear bgp vrf all ipv4 unicast * soft out" + "\n")
    target.write("!\n")
